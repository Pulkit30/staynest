    ...
    <div>
      <div className="w-[100vw] min-h-[80px] border-b-[1px] border-[#dcdcdc] px-[20px] flex items-center justify-between md:px-[40px]">
        <div className="flex items-center gap-[10px]">
          <img src={logo} alt="logo" className="h-[65px] w-[70px] pt-[10px]" />{" "}
          <span className="text-[18px] font-bold text-[red] mt-[15px]">
            StayNest
          </span>
        </div>
        ...
        <div className="flex items-center justify-center gap-[10px] relative">
          ...
          <button
            className="px-[20px] py-[10px] flex items-center justify-center gap-[5px] border-[1px] rounded-[50px] hover:shadow-lg"
          ...
          {showpopup ? (
            <div className="w-[220px] h-[250px] absolute bg-slate-50 top-[110%] md:right-[10%] right-[3%] border-[1px] border-[#aaa9a9] z-10 rounded-lg ">
      ...
      <div className="w-[100vw] h-[85px] bg-white flex items-center justify-start cursor-pointer gap-[40px] overflow-auto md:justify-center px-[15px]">
        <div className="flex flex-col items-center justify-center hover:border-b-[1px] border-[#a6a5a5] text-[13px]">
        ...
        <div className="flex flex-col items-center justify-center hover:border-b-[1px] border-[#a6a5a5] text-[13px] text-nowrap">
